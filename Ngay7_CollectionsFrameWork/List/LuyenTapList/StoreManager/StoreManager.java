...
và cập nhật giá của chúng (ví dụ: giảm 10%).
Gợi ý: Dùng product.setPrice(...).*/
/*Viết phương thức static void removeOutOfStock(List<Product> products, List<String> outOfStockNames)
Phương thức này nhận vào danh sách sản phẩm và một danh sách tên các sản phẩm đã hết hàng.
